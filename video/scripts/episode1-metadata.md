# CipherStudios TC — Episode 1 — YouTube Upload Package

Runtime (final concatenated file): **10:57** — confirmed against the current
...
case on Earth, the first written law, the first documented serial killer,
and the birth of forensic science.

Every claim in this video is sourced from published archaeological and
historical research — including the one genuinely disputed finding, which
we tell you is disputed rather than pretend it's settled. Sources below.

⏱ TIMESTAMPS
0:00 Welcome
0:05 Cold Open
0:24 Intro — 5 Firsts
1:01 Case 01 — The Oldest Murder (430,000 years ago)
3:13 Case 02 — The Oldest Cold Case (Ötzi the Iceman)
5:02 Case 03 — The First Law (Code of Ur-Nammu)
6:22 Case 04 — The First Serial Killer (Locusta of Gaul)
8:11 Case 05 — The First Forensic Scientist (Song Ci)
9:33 The Throughline & Close

📚 SOURCES
- Sala, N. et al., "Lethal Interpersonal Violence in the Middle Pleistocene,"
  PLOS ONE (2015) — Cranium 17 / Sima de los Huesos
- Smithsonian Magazine, National Geographic, Science News — coverage of the
  Cranium 17 findings and the scientific debate around them
- National Geographic, JSTOR Daily, History.com — Ötzi the Iceman forensic
  reconstruction
- World History Encyclopedia — Code of Ur-Nammu
- CrimeReads, Britannica, Ancient Origins (primary ancient source: Tacitus)
  — Locusta of Gaul
- "Collected Cases of Injustice Rectified" (Wikipedia), Simplyforensic —
  Song Ci, "The Washing Away of Wrongs"

This channel centers victims and evidence, not perpetrators. Disputed
claims are labeled as disputed. Corrections are always welcome in the
comments.

🔔 New case files every week. Subscribe to be here for the next one.
...
## Category
People & Blogs, or Education (either fits; Education may perform better for
long-form sourced documentary content).
...
- **End screen (last 5-20s):** subscribe button + this video's own
  ...
  video, and swap it for a "Case File 002" video element the moment that
  episode is live.
- **Cards:** none needed yet (nothing to link to); revisit once episode 2 exists.
- **Hashtags:** put only the first 2-3 from the description's hashtag line
  above the title (YouTube only surfaces the first 3) — use `#TrueCrime
  #CrimeHistory #ColdCase`, keep the rest in the description body for search.
- **Upload timing:** true-crime/documentary audiences skew evening and
  weekend viewing; a Thursday–Saturday evening upload (viewer's local time)
  gives the algorithm a concentrated early-watch-time signal, which matters
  more for a brand-new channel's first video than for an established one.
- **First 60-90 minutes after publish:** reply to every comment you get —
  early engagement velocity on a new channel's first video is a stronger
  signal than it will be later, precisely because there's no channel
  history yet for YouTube to weigh instead.
- **Community tab:** if available on the channel yet, a short teaser post
  (e.g. the thumbnail + "Case File 001 is live") an hour before or at
  publish gives subscribers-so-far a nudge without relying on browse/search
  alone for the first views.
- **Video description first two lines:** these are the only part visible
...
```
Fun fact we couldn't fit in: the "Washing Away of Wrongs" (1247 AD) — the
book behind Case 05 — didn't just start forensic science. It's also the
first known use of insects as evidence in history: the fly that landed on
the one bloody sickle in that lineup is basically the ancestor of every
"CSI" bug scene ever made. 🪰🔎

Which of these five firsts got you the most — the 430,000-year-old skull,
or the fly? Let us know below. Case File 002 is already in research. 🗂️
```
